...
def save_physics_results_greenheart_setup(config, wind_cost_results):
    """
    Save physics results for GreenHEART setup.
...
def load_physics_greenheart_setup(config):
    """
    Loads the physics setup for the GreenHEART simulation from previously saved pickle files.
...
def save_physics_results_greenheart_simulation(
    ...
    """
    Save the physics results of the GreenHEART simulation to a pickle file.
...
def load_physics_greenheart_simulation(config):
    """
    Load physics simulation results for a GreenHEART simulation.
